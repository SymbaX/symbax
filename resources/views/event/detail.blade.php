                ...
                <div class="event-detail">
                    @if ($event)
                        <div class="event-flex">
                            <div class="thumbnail">
                                <a href="{{ Storage::url($event->image_path_a) }}" data-lightbox="group"><img src="{{ Storage::url($event->image_path_a) }}" width="400"></a>
                                <a href="{{ Storage::url($event->image_path_b) }}" data-lightbox="group"><img src="{{ Storage::url($event->image_path_b) }}" width="400"></a>
                                <a href="{{ Storage::url($event->image_path_c) }}" data-lightbox="group"><img src="{{ Storage::url($event->image_path_c) }}" width="400"></a>
                                <a href="{{ Storage::url($event->image_path_d) }}" data-lightbox="group"><img src="{{ Storage::url($event->image_path_d) }}" width="400"></a>
                                <a href="{{ Storage::url($event->image_path_e) }}" data-lightbox="group"><img src="{{ Storage::url($event->image_path_e) }}" width="400"></a>
                            </div>
                            <div class="right">
                                <div class="scroll">
